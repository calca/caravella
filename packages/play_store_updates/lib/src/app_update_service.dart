...
class AppUpdateService {
  ...
  static Future<AppUpdateInfo?> checkForUpdate() async {
    ...
    try {
      ...
      if (e.code == 'TASK_FAILURE') {
        ...
        LoggerAdapter.info('Update check skipped: App not from Play Store');
        return null;
      }
      LoggerAdapter.warning('Update check failed: ${e.code} - ${e.message}');
      return null;
    } catch (e) {
      // Handle any other errors silently
      LoggerAdapter.warning('Update check error: $e');
      return null;
    }
  }
  ...
  static Future<bool> startFlexibleUpdate() async {
    ...
    try {
      ...
      if (e.code == 'TASK_FAILURE') {
        LoggerAdapter.info('Flexible update skipped: App not from Play Store');
        return false;
      }
      LoggerAdapter.warning('Flexible update failed: ${e.code} - ${e.message}');
      return false;
    } catch (e) {
      LoggerAdapter.warning('Flexible update error: $e');
      return false;
    }
  }
  ...
  static Future<bool> completeFlexibleUpdate() async {
    ...
    try {
      ...
      if (e.code == 'TASK_FAILURE') {
        LoggerAdapter.info('Complete update skipped: App not from Play Store');
        return false;
      }
      LoggerAdapter.warning('Complete update failed: ${e.code} - ${e.message}');
      return false;
    } catch (e) {
      LoggerAdapter.warning('Complete update error: $e');
      return false;
    }
  }
  ...
  static Future<bool> startImmediateUpdate() async {
    ...
    try {
      ...
      if (e.code == 'TASK_FAILURE') {
        LoggerAdapter.info('Immediate update skipped: App not from Play Store');
        return false;
      }
      ...
      LoggerAdapter.warning('Immediate update error: $e');
      return false;
    }
  }
