...
### Added
- **Hive local database backend as default storage for improved performance**
  - 10-50x faster read operations and 5-20x faster write operations compared to JSON
  - Binary format with O(1) indexed lookups for better performance
