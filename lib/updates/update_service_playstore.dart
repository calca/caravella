...
class PlayStoreUpdateService implements UpdateService {
  ...
  @override
  Future<bool> shouldCheckForUpdate() => psu.AppUpdateService.shouldCheckForUpdate();
  ...
  @override
  Future<bool> startFlexibleUpdate() => psu.AppUpdateService.startFlexibleUpdate();
  
  @override
  Future<bool> completeFlexibleUpdate() => psu.AppUpdateService.completeFlexibleUpdate();
  
  @override
  Future<bool> startImmediateUpdate() => psu.AppUpdateService.startImmediateUpdate();
  
  @override
  Future<Map<String, dynamic>> getUpdateStatus() => psu.AppUpdateService.getUpdateStatus();
}
