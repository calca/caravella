...
class ExpenseGroupParticipantsPage extends StatelessWidget {
  final ExpenseGroup? trip;
  final VoidCallback? onTripDeleted;
  final GroupEditMode mode;

  const ExpenseGroupParticipantsPage({
    super.key,
    this.trip,
    this.onTripDeleted,
    required this.mode,
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: _ParticipantsPageScaffold(
        trip: trip,
...
class _ParticipantsPageScaffold extends StatefulWidget {
  final ExpenseGroup? trip;
  final VoidCallback? onTripDeleted;
  final GroupEditMode mode;

  const _ParticipantsPageScaffold({
    required this.trip,
    this.onTripDeleted,
    required this.mode,
  });
  ...
  @override
  State<_ParticipantsPageScaffold> createState() =>
      _ParticipantsPageScaffoldState();
}

class _ParticipantsPageScaffoldState extends State<_ParticipantsPageScaffold> {
