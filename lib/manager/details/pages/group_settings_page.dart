    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Sync section (only shown when sync callbacks are provided)
          if (widget.onShareQr != null ||
              widget.onManageDevices != null ||
              widget.onForceSync != null)
            SettingsSection(
              title: 'Sync',
              description: 'Multi-device synchronization settings',
              children: [
                if (widget.onShareQr != null)
                  SettingsCard(
                    context: context,
