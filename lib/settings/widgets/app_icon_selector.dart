...
class _AppIconSelectorState extends State<AppIconSelector> {
  ...
  Future<void> _saveSelectedIcon(String iconName) async {
    ...
    // Qui in futuro si potrebbe implementare il cambio effettivo dell'icona
    // usando package come flutter_dynamic_icon per Android
    if (mounted) {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.red
            .withValues(alpha: 0.1), // Colore debug per vedere se appare
      ...
      child: Column(
        ...
        children: [
          Text(
            'ICON SELECTOR DEBUG', // Testo debug
