...
class RatingService {
  ...
  static Future<bool> checkAndPromptForRating() async {
    try {
      ...
      await PreferencesService.setTotalExpenseCount(totalExpenses);
      ...
      if (shouldShow) {
        ...
        // Update tracking
        await PreferencesService.setLastRatingPrompt(DateTime.now());
  ...
  static Future<bool> _shouldShowRatingPrompt(int totalExpenses) async {
    ...
    final hasShownInitial = await PreferencesService.getHasShownInitialRating();
