...
void main() {
  group('Export-Import Integration Tests', () {
    test(
      'exported ZIP should be importable and preserve data integrity',
      () async {
...
''';
        ...
        expect(
          zipData,
          isNotNull,
          reason: 'ZIP encoding should not return null',
        );
        ...
        expect(
          decodedArchive.length,
          1,
          reason: 'ZIP should contain exactly 1 file',
        );
        ...
        expect(
          fileFound,
          true,
          reason: 'Backup file should be found in archive',
        );
        expect(
          extractedContent,
          isNotNull,
          reason: 'Extracted content should not be null',
        );
        ...
        expect(
          extractedJson,
          equals(originalJson),
          reason: 'Extracted data should match original data exactly',
        );
