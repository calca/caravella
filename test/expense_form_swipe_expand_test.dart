...
void main() {
  ...
  testWidgets(
    'compact expense form expands via swipe up without expand button',
    (tester) async {
        ...
        MaterialApp(
          ...
          home: Scaffold(
            body: ExpenseFormComponent.legacy(
              participants: [ExpenseParticipant(id: 'p1', name: 'Mario')],
              categories: [ExpenseCategory(id: 'c1', name: 'Food')],
              onExpenseAdded: (_) {},
              onCategoryAdded: (_) {},
              groupId: 'g1',
