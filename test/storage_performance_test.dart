...
void main() {
  group('StoragePerformanceMonitor', () {
    ...
    test('should return null for non-existent operation average', () {
      final average = StoragePerformanceMonitor.getAverageDuration(
        'non-existent',
      );
    ...
    test('should limit metrics to prevent memory leaks', () {
      ...
      expect(
        StoragePerformanceMonitor.metrics.first.operation,
        equals('test200'),
      );
      expect(
        StoragePerformanceMonitor.metrics.last.operation,
        equals('test1199'),
      );
    });
  });
  ...
  group('PerformanceMonitoring Mixin', () {
    ...
    test('should record errors correctly', () async {
      ...
      final metrics = StoragePerformanceMonitor.getMetricsFor(
        'testFailing (error)',
      );
      expect(metrics, hasLength(1));
    });
...
class TestClass with PerformanceMonitoring {
  Future<String> testAsyncOperation() async {
    return await measureOperation('testAsync', () async {
  ...
  int testSyncOperation() {
    return measureSyncOperation('testSync', () {
      return 42;
    });
  }

  Future<void> testFailingOperation() async {
    await measureOperation('testFailing', () async {
